...
typedef struct
{
    ...
    SINT32    X_BROADCOM_COM_WlRadioPwrSaveStaAssocCheck;	/**< X_BROADCOM_COM_WlRadioPwrSaveStaAssocCheck */
    SINT32    X_BROADCOM_COM_WlRxChainPwrSaveStaAssocCheck;	/**< X_BROADCOM_COM_WlRxChainPwrSaveStaAssocCheck */
} Dev2WifiRadioObject;
 ...
 *
 * MDMOID_DEV2_WIFI_NEIGHBORINGWIFIDIAGNOSTIC 2603
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
    UINT16 _sequenceNum;	/**< for internal use only */
    SINT32    diagnosticsState;	/**< DiagnosticsState */
 ...
 *
 * MDMOID_DEV2_WIFI_NEIGHBORINGWIFIDIAGNOSTIC_RESULT 2604
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DEV2_WIFI_ASSOCIATEDDEVICE_STATS 2611
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DEV2_WIFI_ACCESS_POINT_AC 2612
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DEV2_WIFI_ACCESS_POINT_AC_STATS 2613
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DEV2_WIFI_ACCESS_POINT_ACCOUNTING 2614
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DEV2_WIFI_END_POINT 2615
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DEV2_WIFI_END_POINT_STATS 2616
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DEV2_WIFI_END_POINT_SECURITY 2617
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DEV2_WIFI_END_POINT_PROFILE 2618
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DEV2_WIFI_END_POINT_PROFILE_SECURITY 2619
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DEV2_WIFI_END_POINT_WPS 2620
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DEV2_WIFI_END_POINT_AC 2621
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
 ...
 *
 * MDMOID_DEV2_WIFI_END_POINT_AC_STATS 2622
 */
typedef struct
{
    MdmObjectId _oid;	/**< for internal use only */
