 ...
 *
 * $Id: wlc.h 778298 2019-08-29 00:43:36Z $
 */
...
typedef struct wlc_stf {
	...
	uint8	bcnprs_txpwr_offset;	/* user specified additional txpwr backoff for bcn/prs in dB */
} wlc_stf_t;
...
extern INLINE bool sstlookup(wlc_info_t *wlc, uint16 proto);
