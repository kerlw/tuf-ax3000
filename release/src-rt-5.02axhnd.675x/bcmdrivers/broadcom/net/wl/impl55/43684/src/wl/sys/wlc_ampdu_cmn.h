 ...
 *
 * $Id: wlc_ampdu_cmn.h 778056 2019-08-21 17:07:12Z $
*/
...
#define AMPDU_PPDU_FT_VHTMU	1
#define AMPDU_PPDU_FT_HEMMU	2
#define AMPDU_PPDU_FT_HEOMU	3
#define AMPDU_PPDU_FT_HEMOM	4
...
extern int wlc_ampdu_ecounter_pack_xtlv(uint16 tag, xtlv_desc_t *xtlv_desc,
...
extern void wlc_ampdu_dump_table(struct bcmstrbuf *b, char* title,
	uint32 *table_val, char* title_per, uint32 *tsuccess,
	int max_idx, int nbr_colums, table_type_t table_type);

#endif /* BCMDBG || BCMDBG_DUMP || WLTEST || BCMDBG_AMPDU || DL_RU_STATS_DUMP || UL_RU_STATS_DUMP */
