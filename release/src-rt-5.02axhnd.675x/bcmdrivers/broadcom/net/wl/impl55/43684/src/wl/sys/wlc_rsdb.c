 ...
 *
 * $Id: wlc_rsdb.c 778668 2019-09-06 14:34:49Z $
 */
...
static void wlc_rsdb_mode_change_complete(wlc_info_t *wlc)
{
	...
	if (NBANDS(wlc) > 1 && band->bandunit != CHSPEC_BANDUNIT(wlc->chanspec))
...
#endif /* #if defined(BCMDBG) || defined(BCMDBG_DUMP) || defined (WLTEST) || defined(BCMDBG_RSDB) */
