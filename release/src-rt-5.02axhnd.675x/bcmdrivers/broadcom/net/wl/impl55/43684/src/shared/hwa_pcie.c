...
#if defined(BCMDBG) || defined(BCMDBG_DUMP) || defined(HWA_DUMP)
...
{
#if (HWA_DEBUG_BUILD >= 3) || defined(BCMDBG) || defined(BCMDBG_DUMP) || \
	defined(HWA_DUMP)
	uint32 index;
...
#endif /* HWA_DEBUG_BUILD >= 3 || BCMDBG || BCMDBG_DUMP  || HWA_DUMP */
}
