 ...
 *
 * $Id: threadx.c 778677 2019-09-06 18:48:53Z $
 */
...
threads_cmd(void *arg, int argc, char *argv[])
{
	...
	printf("NAME                   TX_PTR ST PRIO  STACK   "
		"USED   HIGH    START      END Q_CUR Q_CAP Q_ERR\n");
