...
TARGETS		:= \
	...
	pcie-ag-fdap-mbss-mfp-wl11k-wl11u-wnm-txbf-pktctx-amsdutx-ampduretry-proptxstatus-chkd2hdma-11nprop-obss-dbwsw-ringer-dmaindex16-bgdfs-cevent-hostpmac-murx
...
# 43684c0 has >2M MEMSIZE, so need to disable HNDLBUFCOMPACT feature.
#
...
# SW (ucode-controlled) GPIO BT coex - btcx ucode chosen if boardflags BFL_BTCOEX bit set
EXTRA_DFLAGS	+= -DBCMSWCOEX -DWL_BTC_WIRE=3
ifeq ($(call opt,debug),1)
	EXTRA_DFLAGS		+= -DBOARD_GPIO_BTC3W_IN=0x5 -DBOARD_GPIO_BTC3W_OUT=0x1a
else
	EXTRA_DFLAGS		+= -DBOARD_GPIO_BTC3W_IN=0x5 -DBOARD_GPIO_BTC3W_OUT=0x2
endif
...
EXTRA_DFLAGS	+= -DRX_DEBUG_ASSERTS
endif
