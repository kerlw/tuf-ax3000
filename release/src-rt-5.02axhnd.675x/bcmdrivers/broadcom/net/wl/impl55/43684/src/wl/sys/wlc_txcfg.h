...
#define VHTMU_USRCNT_MIN	MUCLIENT_NUM_MIN
#define HEMU_USRCNT_MIN		MUCLIENT_NUM_MIN

#define VHTMU_USRCNT_MAX	MUCLIENT_NUM
#define HEMU_USRCNT_MAX		MUCLIENT_NUM
