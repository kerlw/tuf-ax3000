...
BASE_FW_IMAGE		:= pcie-ag-splitrx-mfp-pktctx-amsdutx-ampduretry-ringer-dmaindex16-txbf-hostpmac-dhdhdr-avs-cu-vasip-ampduhostreorder-murx-wrr-sae-swprbrsp

# FDAP features
FDAP_FEATURES		:= fdap-mbss-wl11k-wl11u-wnm-chanim-bgdfs-cevent-pspretend-stamon-fbt-osen-obss-dbwsw-mbo-mutx-cca-ccamesh-map-splitassoc-led-slvradar-atm-memallocstats-dpp
...
# STA features
STA_FEATURES		:= idsup-idauth-slvradar
...
UTF_FEATURES_DTPC	:= $(STA_FEATURES)-dtpc
...
TARGET_OPTIONS_config_pcie_fdap_internal_utf_dtpc	:= $(BASE_FW_IMAGE)-$(FDAP_FEATURES)-$(DATAPATH_FEATURES)-$(MFGTEST_FEATURES)-$(INTERNAL_FEATURES)-$(UTF_FEATURES_DTPC)
...
TARGET_OPTIONS_config_sdio_ate				:= sdio-ag-ate-dump-fdap-txbf
