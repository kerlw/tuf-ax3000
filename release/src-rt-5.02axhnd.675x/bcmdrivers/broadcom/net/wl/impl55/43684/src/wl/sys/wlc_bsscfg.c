 ...
 *
 * $Id: wlc_bsscfg.c 778593 2019-09-05 09:47:04Z $
 */
...
#endif /* BCMDBG || BCMDBG_DUMP || DNG_DBGDUMP */
...
#define WL_TRAFFIC_THRESH_BSS_TH 60
#define WL_TRAFFIC_THRESH_BSS_TO_NS 5
#define WL_TRAFFIC_THRESH_BSS_TO_TH 80
