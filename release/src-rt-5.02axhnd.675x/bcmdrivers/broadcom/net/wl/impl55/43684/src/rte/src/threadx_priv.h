 ...
 *
 * $Id: threadx_priv.h 778441 2019-09-01 10:06:08Z $
 */
...
uint32 threadx_fiq_isr(void);

/* Function to get threadx info when trap occurs */
void hnd_trap_threadx_info(void);

/* shell command handler */
void hnd_ths_cli_init(void);
