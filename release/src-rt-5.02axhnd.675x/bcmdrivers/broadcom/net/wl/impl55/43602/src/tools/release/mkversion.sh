...
#        src/router/shared/version.h.in \
#        src/router/shared/router_version.h \
#        AKASHI_REL_5_110_25
#
#  # $Id: mkversion.sh 397222 2013-04-17 20:00:23Z $
#
...
SVNURL='$HeadURL: http://bcawlan-svn.sj.broadcom.net/svn/bcawlan/proj/branches/BISON05T_TWIG_7_35_260_93/src/tools/release/mkversion.sh $'
