...
#
# $Id: epivers.sh 640153 2016-05-26 10:48:09Z $
#
...
if [ -f epivers.h ]; then
	...
	SVNURL='$HeadURL: http://bcawlan-svn.sj.broadcom.net/svn/bcawlan/proj/branches/BISON05T_TWIG_7_35_260_93/src/include/epivers.sh $'
