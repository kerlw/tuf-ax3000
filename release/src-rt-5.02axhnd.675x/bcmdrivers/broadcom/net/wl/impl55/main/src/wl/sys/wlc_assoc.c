 ...
 *
 * $Id: wlc_assoc.c 778783 2019-09-10 12:31:05Z $
 */
	...
	chanspec_t chanspec, uint8 mcsallow, uint flags)
{
	...
	if (flags & JOIN_BSS_FLAG_VHT_CAP) {
		...
		wlc_vht_update_scb_state(wlc->vhti,
				CHSPEC_BANDTYPE(chanspec), scb, NULL, NULL, NULL, 0);
	}
#endif /* WL11AC */
#ifdef WL11AX
	...
	void *params, uint p_len, void *arg, uint len, uint val_size, struct wlc_if *wlcif)
{
	...
	case IOV_GVAL(IOV_ROAM_PROF):
	{
		...
		bandunit = BAND_2G(int_val) ? BAND_2G_INDEX : BAND_5G_INDEX;
	...
	case IOV_SVAL(IOV_ROAM_PROF):
	{
		...
		bandunit = BAND_2G(int_val) ? BAND_2G_INDEX : BAND_5G_INDEX; /* TODO:6G */
