 ...
 *
 * $Id: wlc_rate.h 778056 2019-08-21 17:07:12Z $
 */
...
typedef struct wlc_rateset {
	...
	uint16  he_bw80_tx_mcs_nss;	/**< supported HE Tx mcs nss set for the BW 80Mhz */
	uint16  he_bw80_rx_mcs_nss;	/**< supported HE Rx mcs nss set for the BW 80Mhz */
...
#else
#define RSPEC_REFERENCE_RATE(rspec) RSPEC2RATE(rspec)
#endif // endif
