 ...
 *
 * $Id: wbd.h 778661 2019-09-06 12:28:01Z $
 */
...
#define WBD_BKT_SLV_FLAGS_WNM_NO_BTQ_RESP	0x0004	/* Do not send BTM request from firmware for
							 * the BTM Query from a STA. Let application
							 * handle it
							 */
...
#define WBD_DEF_AVOID_LOOP_BSS_DOWN	0	/* Avoid loop using BSS down */
#define WBD_DEF_AVOID_LOOP_MAC_BLOCK	1	/* Avoid loop using MAC Block */
...
#define NVRAM_MAP_CHSCAN_FORCE_ONBOOT	"map_chscan_force_onboot"
