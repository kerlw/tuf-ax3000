 ...
 *
 * $Id: wbd_blanket_utility.h 778661 2019-09-06 12:28:01Z $
 */
...
extern void wbd_slave_enable_disable_backhaul_bss(int enable);
...
unsigned char wbd_blanket_get_bh_sta_profile(char *wds_ifname);
