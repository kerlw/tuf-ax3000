 ...
 *
 * $Id: wlc_scan_utils.h 777806 2019-08-12 07:55:48Z $
 */
...
/* CMN structure accross WLCs for RSDB. */
typedef struct wlc_scan_utils_cmn {
	/* ESCAN */
	/** An unique request ID is associated to correlate request/response-set */
	uint16	escan_sync_id;
} wlc_scan_utils_cmn_t;

/* module info */
struct wlc_scan_utils {
	wlc_info_t *wlc;
	wlc_scan_utils_cmn_t *cmn;		/* CMN elements accross WLC's */
