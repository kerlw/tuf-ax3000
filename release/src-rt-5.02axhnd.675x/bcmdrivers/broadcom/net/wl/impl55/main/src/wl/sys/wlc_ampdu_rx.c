 ...
 *
 * $Id: wlc_ampdu_rx.c 778655 2019-09-06 11:27:56Z $
 */
...
wlc_ampdu_rx_dump(ampdu_rx_info_t *ampdu_rx, struct bcmstrbuf *b)
{
	...
	wlc_ampdu_dump_table(b, "RX HT", ampdu_rx->amdbg->rxmcs,
		NULL, NULL, AMPDU_HT_MCS_LAST_EL, MAX_HT_RATES, TABLE_MCS);
#ifdef WL11AC
	wlc_ampdu_dump_table(b, "RX VHT", ampdu_rx->amdbg->rxvht,
		NULL, NULL, AMPDU_MAX_VHT, MAX_VHT_RATES, TABLE_MCS);
#endif /* WL11AC */

	if (WLC_SGI_CAP_PHY(wlc)) {
		wlc_ampdu_dump_table(b, "RX HT SGI", ampdu_rx->amdbg->rxmcssgi,
			NULL, NULL, AMPDU_HT_MCS_LAST_EL, MAX_HT_RATES, TABLE_MCS);
#ifdef WL11AC
		wlc_ampdu_dump_table(b, "RX VHT SGI", ampdu_rx->amdbg->rxvhtsgi,
			NULL, NULL, AMPDU_MAX_VHT, MAX_VHT_RATES, TABLE_MCS);
#endif /* WL11AC */
	}
	...
	for (gi = 0; gi < AMPDU_MAX_HE_GI; gi++) {
		...
		wlc_ampdu_dump_table(b, name, ampdu_rx->amdbg->rxhe[gi],
