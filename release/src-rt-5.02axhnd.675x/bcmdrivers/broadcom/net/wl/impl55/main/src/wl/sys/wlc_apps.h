 ...
 *
 * $Id: wlc_apps.h 778753 2019-09-10 06:20:42Z $
*/
...
uint32 wlc_apps_scb_in_ps_time(wlc_info_t *wlc, struct scb *scb);
uint32 wlc_apps_scb_in_pvb_time(wlc_info_t *wlc, struct scb *scb);
...
extern void wlc_apps_twt_exit(wlc_info_t *wlc, scb_t *scb);
...
extern void wlc_apps_pvb_update_bcmc(wlc_info_t *wlc, struct scb *scb, bool on);
