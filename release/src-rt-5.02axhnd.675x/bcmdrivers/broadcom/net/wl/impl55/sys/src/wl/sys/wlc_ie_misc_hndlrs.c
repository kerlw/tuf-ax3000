 ...
 *
 * $Id: wlc_ie_misc_hndlrs.c 776311 2019-06-25 11:11:14Z $
 */
...
#if defined(WL_FILTERIE)
	if (!wlc_filter_ie_is_ie_allowed(cfg, data->ft, FALSE,
		WLC_IEM_VS_ID_MAX, FALSE, (const vndr_ie_t *)cfg->brcm_ie)) {
		return 0;
	}
#endif /* WL_FILTERIE */
