 ...
 *
 * $Id: wlc_channel.h 778694 2019-09-09 01:45:48Z $
 */
...
extern const chanvec_t chanvec_all_6G;
#endif // endif
...
extern bool
wlc_valid_channel2p5_in_band(wlc_cm_info_t *wlc_cm, enum wlc_bandunit bandunit, uint val);
extern bool wlc_valid_channel5_in_band(wlc_cm_info_t *wlc_cm, enum wlc_bandunit bandunit, uint val);
extern bool
wlc_valid_channel10_in_band(wlc_cm_info_t *wlc_cm, enum wlc_bandunit bandunit, uint val);
extern bool
